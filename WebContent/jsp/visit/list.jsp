									...
									<td>
										<table id="grid"
											...
											<tbody>
												...
												<!--  -->
												<%---- pageBean{currentPage \ totalPage \ pageSize \ totalSize \ list} -- push 
													
													<s:iterator var="visit" value="list">  ： 遍历也放值栈， 放到context区域，有一个名字叫做visit 对上这个遍历出来的对象
														<s:property value="#visit.visit_time" />
														
													
													<s:iterator  value="list">  : 遍历出来直接放置在栈顶  list区域  
