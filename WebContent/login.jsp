		              								...
		              								<TBODY>
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px" width=370>
										                		<SPAN  id=RequiredFieldValidator3 style="FONT-WEIGHT: bold; VISIBILITY: visible; COLOR: red">
										              	...
										              	<TR>
										                	<TD style="HEIGHT: 28px">验证码：</TD>
										               	 	...
										               	 	<%-- //在userAction里面的getCode方法写上如下代码：
										               	 	
										               	 	ValidateCode code = new ValidateCode(130 , 50  , 4, 9);
										               	 	
										               	 	String c = code.getCode();
										               	 	
										               	 	<img src="${pageContext.request.contextPath }/user_getCode"/> --%>
